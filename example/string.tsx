...
const Example = () => (
  ...
  print "Welcome to flavor country!";
      ...
      <li>
        ...
        <pre>
          <code>
            ...
            precariously on pot handle wait 10 minutes goto first step (or shut
            off burner when done)
          </code>
        </pre>
    ...
    <p>
      Here's a link to{" "}
      <a href="http://foo.bar" rel="nofollow">
        a website
      </a>
      , to a <a href="local-doc.html">local doc</a>, and to a{" "}
    ...
    <hr />
    <p>9 leather brown 10 hemp canvas natural 11 glass transparent</p>
    ...
    <p>keyword text</p>
    <hr />
    <p>red Sunsets, apples, and other red or reddish things.</p>
    ...
    <p>
      apples : Good for making applesauce. oranges : Citrus! tomatoes : There's
      no "e" in tomatoe.
    </p>
    <p>
    ...
    <p>
      <a target="_blank" rel="noopener noreferrer" href="example-image.jpg">
        <img
